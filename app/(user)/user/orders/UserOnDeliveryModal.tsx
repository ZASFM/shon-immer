...
import App from "@/app/components/common/AppMap";
import { UserOrderCollected, UserOrderPreparing } from "./ViewOrderStatus";
...
const UserOnDeliveryModal=({order}:UserOnDeliveryModalProps)=>{
   ...
   return (
     <>
       ...
       >
         {order.status !== "DELIVERED" && <App width={400} height={200} />}
         <div className="my-4">
